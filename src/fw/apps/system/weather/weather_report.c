...
// (2026-07-06 night). The original weather app's layout engine
// (weather_app_layout — bowens ideal version, styled to the original Pebble
...
// ---- Hold-to-scroll with acceleration (raw click subscriber + AppTimer) ----
// The bowens-ideal contract, verbatim timing: a single tap steps one day; holding UP/DOWN kicks
